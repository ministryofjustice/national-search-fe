            ...
            <div>
                <div className="panel panel-border-narrow">
                    ...
                    <p className="no-margin bottom">
                        ...
                        <span id="risk">Risk <span className={'risk-icon risk-' + data.CURRENT_HIGHEST_RISK_COLOUR.toLowerCase()}> </span>&nbsp;|&nbsp;</span>
                        }
                        {data.CURRENT_DISPOSAL > 0 &&
                        <span id="currentDisposal">Current offender&nbsp;|&nbsp;</span>
                        }
                        <Highlighter highlightClassName="highlight" searchWords={searched} autoEscape={true} textToHighlight={Result.pipeGender(data.GENDER_ID) + ', ' + Result.pipeAge(data.DATE_OF_BIRTH_DATE)}/>
                    </p>
