...
describe('Result', () => {
    ...
    describe('when a basic search is performed', () => {
        ...
        beforeEach(() => {
            ...
            clickSpy = sinon.spy();
            wrapper = mount(<Result params={params} data={searchData} contact={contactSpy} click={clickSpy}/>);
        });
    ...
    describe('when searching for alias and/or address', () => {
        ...
        it('should include additional information based on deep search', () => {
            ...
            expect(additionalResults[3]).toEqual('1 Some Street, Sheffield, South Yorkshire. S1 1AA');
        });
